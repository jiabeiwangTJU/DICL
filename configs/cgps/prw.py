...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(1000, 600), keep_ratio=True),#(334, 200)
...
optimizer = dict(type='SGD', lr=0.0015, momentum=0.9, weight_decay=0.0005) #0.0001)
SPCL=True
PSEUDO_LABELS = dict(
    freq=1, # epochs
    use_outliers=True,
