...
class ReidRoIHead(BaseRoIHead, BBoxTestMixin, MaskTestMixin):
    ...
    def _bbox_forward(self, x, rois, gt_x=None, sampling_results=None):
        ...
        if self.with_shared_head:
            ...
            if gt_x is not None:
                ...
                gt_bbox_feats = None
        cls_score, bbox_pred, id_pred, gt_id_pred = self.bbox_head(bbox_feats, gt_bbox_feats, sampling_results)
